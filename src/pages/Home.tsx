  ...
  const content = {
    en: {
      hero: {
        ...
        subtitle:
          'Advanced Aviation Training Platform with AI-Powered Learning',
        description:
          'Transform your aviation career with our comprehensive training programs, cutting-edge simulation technology, and global certification standards.',
        ...
        items: [
          {
            ...
            description:
              'State-of-the-art simulators and real-world training scenarios',
          },
          {
        ...
        items: [
          {
            ...
            description:
              'Learn in your preferred language with real-time translation',
          },
          {
            icon: <Award className="h-6 w-6" />,
            title: 'Certification Ready',
            description:
              'All courses designed to meet global certification standards',
          },
          {
            icon: <Clock className="h-6 w-6" />,
            title: 'Flexible Learning',
            description:
              'Self-paced courses with 24/7 access to learning materials',
          },
          {
            icon: <CheckCircle2 className="h-6 w-6" />,
            title: 'Quality Assured',
            description:
              'Regular updates and quality checks on all training materials',
          },
        ],
      },
    },
    fr: {
      hero: {
        ...
        subtitle:
          'Plateforme de Formation Aéronautique Avancée avec Apprentissage IA',
        description:
          'Transformez votre carrière aéronautique avec nos programmes de formation complets, notre technologie de simulation de pointe et nos normes de certification mondiales.',
        ...
        items: [
          {
            ...
            description:
              'Simulateurs de pointe et scénarios de formation réels',
          },
          {
            icon: <Users className="h-6 w-6" />,
            title: 'Instructeurs Experts',
            description:
              "Apprenez auprès de professionnels du secteur avec des décennies d'expérience",
          },
          {
            icon: <BookOpen className="h-6 w-6" />,
          ...
          },
          {
            ...
            description:
              'Répond aux normes aéronautiques NCAA et internationales',
          },
        ],
      },
      stats: {
        ...
        items: [
          {
            ...
            description:
              'Apprenez dans votre langue préférée avec traduction en temps réel',
          },
          {
            icon: <Award className="h-6 w-6" />,
            title: 'Prêt pour Certification',
            description:
              'Tous les cours conçus pour répondre aux normes de certification mondiales',
          },
          {
            icon: <Clock className="h-6 w-6" />,
            title: 'Apprentissage Flexible',
            description:
              "Cours à votre rythme avec accès 24/7 aux matériels d'apprentissage",
          },
          {
            icon: <CheckCircle2 className="h-6 w-6" />,
            title: 'Qualité Garantie',
            description:
              'Mises à jour régulières et contrôles de qualité sur tous les matériels de formation',
          },
        ],
      },
    },
      ...
      <section className="py-16 bg-gradient-to-r from-blue-600 to-purple-600 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
            Download our mobile apps for on-the-go learning or access our full
