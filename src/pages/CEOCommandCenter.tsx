        ...
        {quickActions.map((action, index) => (
          ...
          >
            <CardContent className="p-6">
              <div
                className={`p-3 rounded-xl bg-gradient-to-r ${action.color} w-12 h-12 flex items-center justify-center mb-4`}
              >
                {action.icon}
              </div>
