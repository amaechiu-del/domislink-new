...
export default function AppsDownload({ language = 'en' }: AppsDownloadProps) {
  const content = {
    en: {
      ...
      subtitle:
        'Download our mobile apps or use our web platform - Your aviation training, anywhere',
      mobile: {
        title: 'Mobile Apps',
        ...
        items: [
          {
            ...
            description:
              'Military-grade encryption and compliance with aviation security standards',
          },
          {
            icon: <Zap className="h-6 w-6" />,
            title: 'Lightning Fast',
            description:
              'Optimized performance for smooth training experience across all devices',
          },
          {
            icon: <Users className="h-6 w-6" />,
            title: 'Multi-User Ready',
            description:
              'Support for individual learners, flight schools, and enterprise teams',
          },
          {
        ...
        items: [
          {
            ...
            rating: 5,
            comment:
              'The mobile app revolutionized how I conduct ground school sessions with my students.',
          },
          {
            ...
            rating: 5,
            comment:
              'Seamless transition between desktop and mobile - my progress is always synced.',
          },
          {
            ...
            rating: 5,
            comment:
              'Our entire academy runs on DomisLink platform. The web access is perfect for our computer labs.',
          },
        ],
      },
      faq: {
        ...
        items: [
          {
            ...
            answer:
              'No! Our web platform offers full functionality without any downloads. Mobile and desktop apps provide enhanced offline capabilities.',
          },
          {
            question: 'Is my progress synced across devices?',
            answer:
              'Yes, all your progress, certificates, and learning data are automatically synced across web, mobile, and desktop platforms.',
          },
          {
            question: 'What are the system requirements?',
            answer:
              'Web: Any modern browser. Mobile: iOS 13+ or Android 8+. Desktop: Windows 10+, macOS 10.14+, or Linux Ubuntu 18.04+.',
          },
          {
            question: 'Is offline learning supported?',
            answer:
              'Yes, our mobile and desktop apps support full offline functionality. Download courses and continue learning without internet.',
          },
        ],
      },
    },
    fr: {
      ...
      subtitle:
        'Téléchargez nos applications mobiles ou utilisez notre plateforme web - Votre formation aéronautique, partout',
      mobile: {
        title: 'Applications Mobiles',
        subtitle:
          'Apprenez en déplacement avec nos applications mobiles natives',
        features: [
        ...
        items: [
          {
            ...
            description:
              'Chiffrement de niveau militaire et conformité aux normes de sécurité aéronautique',
          },
          {
            icon: <Zap className="h-6 w-6" />,
            title: 'Ultra Rapide',
            description:
              'Performance optimisée pour une expérience de formation fluide sur tous les appareils',
          },
          {
            icon: <Users className="h-6 w-6" />,
            title: 'Prêt Multi-utilisateurs',
            description:
              'Support pour apprenants individuels, écoles de pilotage et équipes entreprises',
          },
          {
            icon: <BarChart3 className="h-6 w-6" />,
            title: 'Analyses Avancées',
            description:
              'Suivi de progression en temps réel et insights de performance',
          },
        ],
      },
      testimonials: {
        ...
        items: [
          {
            ...
            rating: 5,
            comment:
              "L'application mobile a révolutionné la façon dont je conduis les sessions de sol avec mes étudiants.",
          },
          {
            ...
            rating: 5,
            comment:
              'Transition transparente entre bureau et mobile - ma progression est toujours synchronisée.',
          },
          {
            ...
            rating: 5,
            comment:
              "Notre académie entière fonctionne sur la plateforme DomisLink. L'accès web est parfait pour nos salles informatiques.",
          },
        ],
      },
      faq: {
        ...
        items: [
          {
            question:
              "Dois-je télécharger l'application pour utiliser la plateforme?",
            answer:
              'Non! Notre plateforme web offre une fonctionnalité complète sans aucun téléchargement. Les applications mobiles et bureau offrent des capacités hors ligne améliorées.',
          },
          {
            question:
              'Ma progression est-elle synchronisée entre les appareils?',
            answer:
              "Oui, toute votre progression, certificats et données d'apprentissage sont automatiquement synchronisés entre les plateformes web, mobile et bureau.",
          },
          {
            question: 'Quelles sont les exigences système?',
            answer:
              'Web: Tout navigateur moderne. Mobile: iOS 13+ ou Android 8+. Bureau: Windows 10+, macOS 10.14+, ou Linux Ubuntu 18.04+.',
          },
          {
            question: "L'apprentissage hors ligne est-il pris en charge?",
            answer:
              'Oui, nos applications mobiles et bureau prennent en charge la fonctionnalité hors ligne complète. Téléchargez les cours et continuez à apprendre sans internet.',
          },
        ],
      },
    },
        ...
        <Card className="bg-gradient-to-r from-blue-600 to-purple-600 text-white text-center">
          <CardContent className="pt-12 pb-12">
            ...
            <p className="text-blue-100 mb-6 max-w-2xl mx-auto">
              Join thousands of aviation professionals who trust DomisLink for
              their training needs. Start with our web platform instantly or
              download our mobile apps for on-the-go learning.
            </p>
