    ...
    setFlightParams((prev) => {
      switch (control) {
        ...
        case 'airspeed':
          return {
            ...prev,
            airspeed: Math.max(60, Math.min(200, prev.airspeed + value)),
          }
        default:
          return prev
      }
    ...
    <ProtectedContent>
      <div className="h-screen bg-gradient-to-b from-slate-900 to-blue-900 text-white flex flex-col">
            ...
            <div className="flex-1 bg-slate-900 relative overflow-hidden">
              ...
              <div className="absolute inset-0 bg-gradient-to-b from-blue-400 to-blue-600 flex items-center justify-center">
                <div className="text-center text-white/80">
                  ...
                  <p className="text-sm">
                    Live aircraft rendering and terrain display
                  </p>
                </div>
              </div>
                  ...
                  <div className="flex space-x-4">
                    <div>
                      ...
                      <span className="text-white ml-1">
                        {flightParams.latitude.toFixed(4)}°
                      </span>
                    </div>
                    <div>
                      <span className="text-blue-300">Lon:</span>
                      <span className="text-white ml-1">
                        {flightParams.longitude.toFixed(4)}°
                      </span>
                    </div>
                  </div>
                  <div>
        ...
        <ChartsModal
          ...
          currentLocation={{
            lat: flightParams.latitude,
            lng: flightParams.longitude,
          }}
        />
      </div>
    </ProtectedContent>
