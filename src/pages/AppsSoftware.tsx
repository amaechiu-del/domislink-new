...
export default function AppsSoftware() {
  const [activeCategory, setActiveCategory] = useState<
    'all' | 'simulator' | 'dashboard' | 'education' | 'enterprise'
  >('all')
  ...
  const softwareProducts: SoftwareProduct[] = [
    {
      ...
      category: 'simulator',
      description:
        'Professional Flight Management System training simulator with realistic 3D cockpit and AI instructor',
      status: 'released',
    ...
    },
    {
      ...
      category: 'simulator',
      description:
        'AI-powered flight training platform with PPL, CPL, ATPL programs and instrument recurrency',
      status: 'released',
    ...
    },
    {
      ...
      category: 'dashboard',
      description:
        'Enterprise financial management dashboard with AI-powered analytics and automated reporting',
      status: 'released',
      platforms: ['web'],
      pricing: {
        model: 'subscription',
    ...
    },
    {
      ...
      category: 'dashboard',
      description:
        'Intelligent property management and investment analysis with predictive market insights',
      status: 'beta',
      platforms: ['web', 'mobile'],
      pricing: {
        model: 'subscription',
    ...
    },
    {
      ...
      category: 'education',
      description:
        'Interactive learning platform with AI-powered content and certification programs',
      status: 'released',
      platforms: ['web', 'mobile'],
      pricing: {
        model: 'one-time',
    ...
    },
    {
      ...
      category: 'education',
      description:
        'Comprehensive educational platform for universities with AI-powered learning management',
      status: 'development',
      platforms: ['web'],
      pricing: {
        model: 'enterprise',
  ...
  const monetizationStreams = [
    {
      ...
      description:
        'One-time purchases and perpetual licenses for software products',
    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-900 to-blue-900 text-white">
      ...
      <section className="py-20 bg-gradient-to-r from-cyan-600 to-blue-800">
        <div className="container mx-auto px-4 text-center">
          ...
          <h1 className="text-5xl font-bold mb-6">DomisLink Apps & Software</h1>
          <p className="text-xl text-cyan-100 mb-8 max-w-3xl mx-auto">
            Professional software solutions powered by DomisLink International
            Business Services Ltd, Lagos, Nigeria
          </p>
          ...
          <Card className="bg-slate-800/70 border-cyan-500/30 backdrop-blur-sm">
            ...
            <CardContent className="text-center">
              <div className="max-w-4xl mx-auto space-y-4 text-cyan-100">
                <p className="text-lg">
                  <strong>Project:</strong> DOMISLINK APPS & SOFTWARE
                  <br />
                  <strong>Parent Entity:</strong> Domislink International
                  Business Services Ltd, Lagos, Nigeria
                  <br />
                  <strong>Founder:</strong> Amaechi Ubadike
                </p>
                <p>
                  All design systems, source code, UX structure, and software
                  architecture related to Domislink Apps & Software are wholly
                  owned, controlled, and licensed under Domislink International
                  Business Services Ltd.
                </p>
                <div className="bg-cyan-500/10 border border-cyan-400/30 rounded-lg p-4 mt-4">
                  <p className="font-semibold text-cyan-300">
                    "Powered by Domislink Apps & Software — A Division of
                    Domislink International Business Services Ltd, Lagos,
                    Nigeria."
                  </p>
                </div>
              </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-cyan-200 max-w-2xl mx-auto">
              Professional-grade software solutions across multiple industries
              and platforms
            </p>
          </div>
                    ...
                    <div className="flex space-x-2">
                      {product.platforms.map((platform) => (
                        <Badge
                          key={platform}
                          variant="outline"
                          className="bg-slate-700/50 text-cyan-200 border-cyan-400/30"
                        >
                          {platform === 'web' && (
                    ...
                    <div className="flex flex-wrap gap-1">
                      {product.technologies.slice(0, 3).map((tech, index) => (
                        <Badge
                          key={index}
                          variant="secondary"
                          className="bg-slate-700/50 text-cyan-200 text-xs"
                        >
                          {tech}
                        </Badge>
                      ))}
      ...
      <section className="py-16 bg-slate-800/30">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-cyan-200 max-w-2xl mx-auto">
              Multi-stream revenue model ensuring sustainable growth and
              profitability
            </p>
          </div>
        ...
        <div className="container mx-auto px-4 text-center">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-cyan-200 mb-4">
              © 2025 Domislink International Business Services Ltd. All Rights
              Reserved.
              <br />
              Contact Support: Domislink International Business Services Ltd,
              Lagos, Nigeria.
            </p>
            <p className="text-amber-200 text-sm">
              Unauthorized copying, redistribution, or modification is
              prohibited.
            </p>
          </div>
        </div>
