  ...
  const programHighlights = [
    {
      ...
      description:
        'Comprehensive training programs for PPL, CPL, and ATPL licenses',
    },
    {
    ...
    },
    {
      ...
      description:
        'Intelligent AI instructor with real-time guidance and feedback',
    },
    {
      ...
      <section className="container mx-auto px-4 py-16">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <p className="text-xl text-blue-100 mb-8 leading-relaxed">
            Advanced virtual flight simulator platform with AI co-pilot
            assistance, live weather integration, and comprehensive training
            programs for PPL, CPL, and ATPL licenses.
          </p>
      ...
      <section className="container mx-auto px-4 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-blue-200 max-w-2xl mx-auto">
            Our platform combines cutting-edge technology with professional
            aviation standards
          </p>
        </div>
      ...
      <section className="container mx-auto px-4 py-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          {licenseLevels.map((program, index) => (
            <Card
              key={index}
              className={`bg-slate-800/50 border-${program.color}-500/30 backdrop-blur-sm hover:border-${program.color}-500/60 transition-all duration-300`}
            >
              <CardHeader className="text-center border-b border-slate-700 pb-4">
                <Badge
                  className={`w-fit mx-auto bg-${program.color}-500/20 text-${program.color}-300 border-${program.color}-400`}
                >
                  {program.level}
                </Badge>
              ...
              <CardFooter>
                <Link
                  to={`/flight-training/courses/${program.level.toLowerCase()}`}
                  className="w-full"
                >
                  <Button
                    className={`w-full bg-${program.color}-500 hover:bg-${program.color}-600 text-white`}
                  >
        ...
        <Card className="bg-slate-800/50 border-slate-700 backdrop-blur-sm">
          <CardHeader className="text-center">
            ...
            <CardDescription className="text-blue-200 text-lg">
              Protected content with license key authentication and session
              management
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
              ...
              <div>
                ...
                <p className="text-blue-200 text-sm">
                  No copy, print, or export capabilities
                </p>
              </div>
              <div>
