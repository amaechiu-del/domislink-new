...
const courseData: Record<string, LicenseCourse> = {
  ppl: {
    ...
    description:
      'Foundational training for single-engine aircraft operations under Visual Flight Rules',
    ...
    aircraft: [
      {
        ...
        image:
          'https://pub-cdn.sider.ai/u/U0Y3HG1OZK0/web-coder/69088bf961d18d65760b5c96/resource/9879da94-b259-44d0-b25e-00d8336d4bbd.jpg',
        specs: {
      ...
      },
      {
        ...
        type: 'Single Engine Piston',
        image:
          'https://pub-cdn.sider.ai/u/U0Y3HG1OZK0/web-coder/69088bf961d18d65760b5c96/resource/080a77bf-0a2d-45fb-97d0-872f0ebb6357.jpg',
        specs: {
    ...
    modules: [
      {
        ...
        description:
          'Understanding aircraft performance and flight characteristics',
        duration: '8 hours',
        type: 'theory',
        completed: true,
        objectives: [
      ...
      },
      {
        ...
        description:
          'Visual flight rules navigation techniques and chart interpretation',
        duration: '10 hours',
        type: 'theory',
        completed: true,
        objectives: [
  ...
  cpl: {
    ...
    description:
      'Advanced training for commercial operations with multi-engine and instrument ratings',
    ...
    aircraft: [
      {
        ...
        image:
          'https://pub-cdn.sider.ai/u/U0Y3HG1OZK0/web-coder/69088bf961d18d65760b5c96/resource/b0fed37a-15f1-420b-b1f7-ec51f603b276.jpg',
        specs: {
      ...
      },
      {
        ...
        type: 'Turboprop',
        image:
          'https://pub-cdn.sider.ai/u/U0Y3HG1OZK0/web-coder/69088bf961d18d65760b5c96/resource/b8cb63e5-7a62-4d55-94ad-f78698b196b2.jpg',
        specs: {
    ...
    modules: [
      {
        ...
        description:
          'Complex aircraft performance and high-altitude operations',
        duration: '12 hours',
        type: 'theory',
        completed: false,
        objectives: [
  ...
  atpl: {
    ...
    description:
      'Professional jet operations, multi-crew coordination, and airline procedures',
    ...
    aircraft: [
      {
        ...
        image:
          'https://pub-cdn.sider.ai/u/U0Y3HG1OZK0/web-coder/69088bf961d18d65760b5c96/resource/c2015f26-bbb7-482b-87c8-ecd341c7c4ca.jpg',
        specs: {
          engines: '2 × CFM56-7B',
          maxSpeed: 'Mach 0.82',
          range: '2,935 nm',
      ...
      },
      {
        ...
        type: 'Narrow-body Jet',
        image:
          'https://pub-cdn.sider.ai/u/U0Y3HG1OZK0/web-coder/69088bf961d18d65760b5c96/resource/65397ce5-899f-4559-86bf-d462e1d6525c.jpg',
        specs: {
    ...
    modules: [
      ...
      },
      {
        ...
        description:
          'Real-world airline operations and scenario-based training',
        duration: '50 hours',
        type: 'simulation',
        completed: false,
        objectives: [
      ...
      <div className="min-h-screen bg-gradient-to-b from-slate-900 to-blue-900 text-white">
        ...
        <header className="container mx-auto px-4 py-6">
          <div className="flex items-center justify-between">
            ...
            <Badge
              className={`bg-${activeTab === 'ppl' ? 'blue' : activeTab === 'cpl' ? 'green' : 'purple'}-500/20 text-${activeTab === 'ppl' ? 'blue' : activeTab === 'cpl' ? 'green' : 'purple'}-300 border-${activeTab === 'ppl' ? 'blue' : activeTab === 'cpl' ? 'green' : 'purple'}-400`}
            >
              {course.title}
            </Badge>
          </div>
                ...
                >
                  <CardContent className="p-6">
                    <div className="flex items-start justify-between">
                      ...
                      <div className="ml-4">
                        <Link
                          to={`/flight-training/simulator?module=${module.id}`}
                        >
                          <Button
                            size="sm"
                            className={
