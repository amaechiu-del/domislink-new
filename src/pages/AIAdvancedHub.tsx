...
export default function AIAdvancedHub({ language = 'en' }: AIAdvancedHubProps) {
  const content = {
      ...
      features: [
        {
          ...
          description:
            'Open-source large language models for specialized aviation tasks',
          status: 'Locked',
        },
        {
          ...
          description:
            'Thousands of pre-trained transformer models for aviation intelligence',
          status: 'Locked',
        },
        {
        ...
        },
        {
          ...
          description:
            'Live AI analysis of flight simulations and student performance',
          status: 'Locked',
        },
      ],
    },
    fr: {
      title: 'Hub IA Avancé',
      subtitle:
        'Débloquez des capacités IA de pointe pour la formation aéronautique',
      ...
      features: [
        {
          ...
          description:
            'Modèles de langage volumineux open source pour les tâches aéronautiques spécialisées',
          status: 'Verrouillé',
        },
        {
          icon: <Users className="h-6 w-6" />,
          ...
          description:
            "Des milliers de modèles transformateurs pré-entraînés pour l'intelligence aéronautique",
          status: 'Verrouillé',
        },
        {
          icon: <Cpu className="h-6 w-6" />,
          ...
          description:
            "Formez des modèles IA spécialisés sur des données spécifiques à l'aviation",
          status: 'Verrouillé',
        },
        {
          icon: <Zap className="h-6 w-6" />,
          ...
          description:
            'Analyse IA en direct des simulations de vol et des performances des étudiants',
          status: 'Verrouillé',
        },
      ],
    },
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
          {currentContent.features.map((feature, index) => (
            ...
            >
              ...
              <CardHeader>
                <div
                  className={`mx-auto p-3 bg-gray-100 rounded-full w-12 h-12 flex items-center justify-center mb-4 text-gray-500`}
                >
                  {feature.icon}
                </div>
