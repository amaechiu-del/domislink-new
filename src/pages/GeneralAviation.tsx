  ...
  const courses = [
    {
      ...
      description:
        'Comprehensive airline pilot training program with advanced theoretical knowledge',
    ...
    },
    {
      ...
      description:
        'Professional pilot training for commercial operations and charter services',
    ...
    },
    {
      ...
      description:
        'Foundational pilot training for private aircraft operation and personal flying',
      duration: '4-6 Months',
      modules: 16,
      level: 'Beginner',
      features: [
  ...
  const learningResources = [
    {
      ...
      description:
        'High-quality instructional videos with 3D animations and real-world scenarios',
    },
    {
      icon: <FileText className="h-6 w-6" />,
      title: 'Digital Textbooks & Manuals',
      description:
        'Comprehensive digital library with updated regulatory materials',
    },
    {
      icon: <Target className="h-6 w-6" />,
      title: 'Practice Exams & Quizzes',
      description:
        'AI-generated practice tests with detailed performance analytics',
    },
    {
    ...
    },
    {
      ...
      description:
        '24/7 access to certified aviation instructors via digital platform',
    },
    {
      icon: <Shield className="h-6 w-6" />,
      title: 'Progress Certification',
      description:
        'Digital badges and certificates for completed modules and milestones',
    },
  ]
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      ...
      <section className="container mx-auto px-4 py-20 text-center">
        ...
        <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
          100% Online ATPL, CPL, and PPL Training Programs. Comprehensive
          digital aviation education with AI-aided learning and expert
          validation.
        </p>
      ...
      <section className="container mx-auto px-4 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Comprehensive 100% online courses designed to meet international
            aviation standards
          </p>
        </div>
      ...
      <section className="bg-white py-16">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Everything you need for successful aviation training, delivered
              100% online
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {learningResources.map((resource, index) => (
              <div
                key={index}
                className="flex items-start space-x-4 p-6 bg-blue-50 rounded-xl hover:bg-blue-100 transition-colors"
              >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl font-bold mb-6">
                Why Choose Our Online Aviation Courses?
              </h2>
              <p className="text-blue-100 mb-8 text-lg">
                Experience the future of aviation education with our
                comprehensive digital platform that combines AI efficiency with
                human expertise.
              </p>
      ...
      <section className="bg-white py-16">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-gray-600 mb-8 max-w-2xl mx-auto">
            Join thousands of students worldwide who have chosen DomisLink for
            their aviation education. Begin your journey to becoming a
            professional pilot with our 100% online courses.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button
              size="lg"
            ...
            <Button
              size="lg"
              variant="outline"
              className="bg-transparent border-gray-600 text-gray-600 hover:bg-gray-50"
            >
