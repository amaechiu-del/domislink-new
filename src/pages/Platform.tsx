  ...
  const platformComponents = [
    {
      ...
      description:
        'Searchable rating list with detailed information and geolocation compliance',
      features: [
        'Searchable aircraft database',
    ...
    },
    {
      ...
      description:
        'Go-based backend with Gin framework for intelligent learning systems',
      features: [
        'Multilingual LLM endpoints',
        'Payment processing',
        'Instructor task handling',
        'Docker deployment',
      ],
    },
    {
      ...
      description:
        'Dynamic course content delivery with AI-assisted personalization',
      features: [
    ...
    },
    {
      ...
      description:
        'Geolocation-based regulatory enforcement and data protection',
      features: [
        'Regional compliance',
        'Data encryption',
  ...
  const aiBehaviors = [
    {
      ...
      description:
        'Supports queries in multiple languages with contextual responses',
    },
    {
      title: 'AI-Assisted Training Content',
      description:
        'Dynamically generates and customizes training modules based on user progress',
    },
    {
    ...
    },
    {
      ...
      description:
        'AI-assisted routine task management and progress monitoring',
    },
    {
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50">
            ...
            <div className="flex items-center space-x-4">
              <div className="text-right">
                <div className="text-sm text-green-600 font-medium">
                  {isAuthenticated
                    ? 'CEO Access - Amaechi Ubadike'
                    : 'Admin Mode'}
                </div>
                {isAuthenticated && (
                  <div className="text-xs text-gray-500">
                    ceo@domislink.com | +2349049837474
                  </div>
                )}
              </div>
              <Button
      ...
      <section className="container mx-auto px-4 py-20 text-center">
        ...
        <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
          Comprehensive technical overview of the DomisLink 100% online AI-aided
      ...
      <section className="bg-white py-16">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Intelligent systems designed to enhance learning while maintaining
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {aiBehaviors.map((behavior, index) => (
              <Card
                key={index}
                className="border-blue-100 hover:shadow-md transition-all"
              >
                <CardHeader>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-blue-100 text-lg max-w-2xl mx-auto">
              Modern, scalable technology foundation for global aviation
              education
            </p>
          </div>
      ...
      <section className="container mx-auto px-4 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Professional development practices for scalable, maintainable
            platform growth
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <Card className="text-center border-blue-200">
            ...
            <CardContent>
              <CardDescription className="text-gray-600">
                GitHub/GitLab repositories with feature branching and code
                reviews
              </CardDescription>
            </CardContent>
          </Card>
      ...
      <section className="bg-white py-16">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-gray-600 mb-8 max-w-2xl mx-auto">
            Join us in revolutionizing aviation education with our comprehensive
            digital platform
          </p>
      ...
      <footer className="bg-gray-900 text-white py-12">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                ...
                <li>
                  <Link to="/ai-features" className="hover:text-white">
                    AI Features
                  </Link>
                </li>
                <li>
          ...
          <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
            <p>
              © 2024 DomisLink Aviation Academy. Comprehensive Digital Platform.
            </p>
          </div>
        </div>
      </footer>
