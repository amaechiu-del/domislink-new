...
export default function NCAACompliance() {
  const [complianceItems, setComplianceItems] = useState<ComplianceItem[]>([
    ...
    },
    {
      ...
      description:
        'All instructors must hold valid NCAA instructor certificates',
  ...
  const calculateComplianceScore = () => {
    ...
    const compliant = complianceItems.filter(
      ...
      <div className="max-w-7xl mx-auto">
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  Nigerian Civil Aviation Authority Regulations for Online
                  Aviation Courses
                </p>
              </div>
            </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6 mb-8">
              ...
              <div className="text-2xl font-bold">
                {
                  complianceItems.filter(
                    (item) =>
                      item.priority === 'high' && item.status !== 'compliant'
                  ).length
                }
              </div>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">
                {
                  complianceItems.filter((item) => item.status === 'compliant')
                    .length
                }
              </div>
                    ...
                    <div className="flex items-start justify-between mb-3">
                      ...
                      <div className="flex items-center space-x-2 ml-4">
                        <Button
                          size="sm"
                          variant={
                            item.status === 'compliant' ? 'default' : 'outline'
                          }
                          className="bg-transparent"
                          onClick={() =>
                            handleStatusChange(item.id, 'compliant')
                          }
                        >
                        ...
                        <Button
                          ...
                          className="bg-transparent"
                          onClick={() =>
                            handleStatusChange(item.id, 'non-compliant')
                          }
                        >
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-3">
                  <div className="font-medium">
                    1. Does your online platform have secure student
                    authentication?
                  </div>
                  <Textarea
                ...
                <div className="space-y-3">
                  <div className="font-medium">
                    3. Describe your record-keeping system for student training
                    records
                  </div>
                  <Textarea
        ...
        <Card className="mt-6">
          <CardHeader>
            ...
            <CardDescription>
              International compliance with ICAO, FAA, EASA, and regional
          ...
          <CardContent>
              ...
              <div className="space-y-4">
                <div className="p-4 bg-blue-50 rounded-lg border border-blue-200">
                  ...
                  <div className="text-sm text-blue-700 mt-1">
                    Compliant with Annex 1 Personnel Licensing and ICAO Doc 9868
                    Training Procedures
                  </div>
                  <div className="text-xs text-blue-600 mt-2">
                    Standards: English Language Proficiency, Evidence-Based
                    Training
                  </div>
                </div>
                ...
                <div className="p-4 bg-red-50 rounded-lg border border-red-200">
                  ...
                  <div className="text-sm text-red-700 mt-1">
                    FAR Part 141 Pilot School standards with advanced training
                    device integration
                  </div>
              ...
              <div className="space-y-4">
                <div className="p-4 bg-purple-50 rounded-lg border border-purple-200">
                  ...
                  <div className="text-sm text-purple-700 mt-1">
                    EASA Part-FCL and Part-ORA standards for theoretical
                ...
                <div className="p-4 bg-green-50 rounded-lg border border-green-200">
                  ...
                  <div className="text-sm text-green-700 mt-1">
                    Adaptable compliance framework for GCAA, CAA, and other
            ...
            <div className="mt-6 p-4 bg-gradient-to-r from-blue-50 to-purple-50 rounded-lg border">
              ...
              <div className="text-sm text-gray-700 space-y-2">
                <p>
                  DomisLink Aviation Academy is committed to maintaining the
                  highest international standards in aviation training. Our
                  platform ensures:
                </p>
                <ul className="list-disc list-inside space-y-1 ml-4">
                  ...
                  <li>
                    Continuous monitoring of evolving international standards
                  </li>
                </ul>
                <p className="text-xs text-gray-600 mt-2">
                  *Advanced implementation methodologies and proprietary
                  training technologies are protected trade secrets. For
                  detailed compliance documentation and implementation
                  strategies, contact our standards team.
                </p>
              </div>
            </div>
            ...
            <div className="mt-4 p-4 bg-yellow-50 rounded-lg border border-yellow-200">
              ...
              <div className="text-sm text-yellow-700 mt-1">
                For detailed compliance documentation, regional adaptation
              ...
              <div className="text-xs text-yellow-600 mt-2 space-y-1">
                ...
                <div className="mt-2 text-yellow-700 font-medium">
                  All proprietary training methodologies and advanced compliance
                  implementations are protected intellectual property.
                </div>
              </div>
            </div>
          </CardContent>
