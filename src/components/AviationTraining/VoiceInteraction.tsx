      ...
      <CardContent className="space-y-4">
          ...
          <div className="bg-amber-500/10 border border-amber-400/30 rounded-lg p-3">
            ...
            <div className="grid grid-cols-2 gap-2">
              <Button
                ...
                onClick={() =>
                  simulateVoiceCommand('Request ILS approach runway 27L')
                }
              >
                ILS Approach
              </Button>
              <Button
                ...
                onClick={() =>
                  simulateVoiceCommand('Executing holding pattern at VOR')
                }
              >
                Holding Procedure
              </Button>
              ...
              <Button
                ...
                onClick={() =>
                  simulateVoiceCommand('Partial panel instruments failure')
                }
              >
                Partial Panel
              </Button>
        ...
        <div className="bg-slate-700/50 rounded-lg p-3">
          ...
          <ul className="text-blue-200 text-xs space-y-1">
            ...
            <li>
              • State intentions clearly: "Request", "Executing", "Completed"
            </li>
            <li>• AI will respond immediately to valid commands</li>
            {examinationMode && (
              <li className="text-amber-300">
                • ALL COMMUNICATIONS ARE RECORDED AND EVALUATED
              </li>
            )}
          </ul>
        </div>
